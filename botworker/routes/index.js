...
//----------------- Специалисты ---------------------------------
router.get('/specialist/get', getSpecialist)
router.get('/specialist/count/get/:count/:prev', getSpecCount) //еще
router.patch('/specialist/update/:id', editSpecialist)
router.get("/specialist/:id", getSpecialistId);
