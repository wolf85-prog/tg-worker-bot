...
//-----------------------------------------------------------------------------------------------
    ...
    Будем рады сотрудничеству на новых проектах!`
        ...
        if (text === '/addworker4') {
            const fio = 'Евгений'
            const chatId = 6976765721
            const age = '1984'
            //const phone2 = '+7 (900) 123-45-45'
            const specArr2 = [{name: 'Отдельные технические задачи'}]
            const city2 = 'Москва'
            const friend2 = 0
            const urlAvatar = 'https://proj.uley.team/upload/2024-06-06T07:52:17.472Z.jpg'
        ...
        if (text === '/addworker5') {
            const fio = 'Татьяна'
            const chatId = 1615527645
            const age = '1998'
            //const phone2 = '+7 (900) 123-45-45'
            const specArr2 = [{name: 'Модель'}]
            const city2 = 'Москва'
            const friend2 = 0
            const urlAvatar = 'https://proj.uley.team/upload/2024-06-06T07:52:17.472Z.jpg'
        ...
        if (text === '/addworker6') {
            const fio = 'Эльдар RouidRonda '
            const chatId = 454206819
            const age = '1996'
            //const phone2 = '+7 (900) 123-45-45'
            const specArr2 = [
